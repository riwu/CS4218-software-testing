...
public class GrepCatIntegrationTest {
    ...
    private static final String DIR_NAME = "grepCatTestDir";
    private static final String FILENAME1 = "grepCatFile1";
    private File dir;
    private File file1;
    ...
    @Test
    public void whenGrepAndCatExpectCatGrepOutput() throws Exception {
    ...
    @Test
    public void whenGrepAndCatWithArgumentExpectCatFile() throws Exception {
